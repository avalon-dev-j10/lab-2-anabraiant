...
import ru.avalon.java.dev.j10.labs.factories.RandomShapes.CircleRandom;
import ru.avalon.java.dev.j10.labs.factories.RandomShapes.RectangleRandom;
import ru.avalon.java.dev.j10.labs.factories.RandomShapes.RhombusRandom;
import ru.avalon.java.dev.j10.labs.factories.RandomShapes.TrapeziumRandom;
import ru.avalon.java.dev.j10.labs.factories.RandomShapes.TriangleRandom;
...
public class RandomShapeFactory implements ShapeFactory {
    ...
    public Shape getInstance() {
      ...
      MathRandomMethod random_number = new MathRandomMethod(0, 5);
      //System.out.println(random_number.mathRandomMethod());
      
      
        switch (random_number.mathRandomMethod()){
            case 0: 
